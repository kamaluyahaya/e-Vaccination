...
class StaffRecord extends StatefulWidget {
  StaffRecord({Key? key}) : super(key: key);
...
class _StaffRecordState extends State<StaffRecord> {
  ...
  Future<void> delete(String user_id) async {
    ...
    try {
      final res = await http.post(Uri.parse(myurl),
          body: {"request": "DELETE STAFF", "id": user_id});
      setState(() {
        isLoading = false;
      });
  ...
  Future<List> getUserData() async {
    ...
    try {
      ...
      var res =
          await http.post(Uri.parse(myurl), body: {"request": "FETCH STAFF"});
              ...
              builder: (context, AsyncSnapshot<List> snapshot) {
                ...
                if (myData == null) {
                  ...
                  return myData.isNotEmpty
                      ...
                      : Center(child: Text("No Staff records"));
                }
              }),
        ),
      ),
