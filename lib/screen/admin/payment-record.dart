...
class PaymentRecord extends StatefulWidget {
  PaymentRecord({Key? key}) : super(key: key);
...
class _PaymentRecordState extends State<PaymentRecord> {
  ...
  Future<List> getUserData() async {
    ...
    try {
      ...
      var res =
          await http.post(Uri.parse(myurl), body: {"request": "FETCH PAYMENT"});
                      ...
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return AdminContainer(
                              ...
                              title:
                                  patientData[index]['tran_id'].toUpperCase(),
                              subtitle:
                                  "Amount paid : NGN ${patientData[index]['amount']}",
                            );
                          })
